...
def reaction_diffusion_radiation(t, P):
    global r  # Use the global growth rate variable
    # Apply radiation at specific intervals (e.g., every 10 time units)
...
sol = solve_ivp(reaction_diffusion_radiation, t_span, P0, t_eval=t, vectorized=True)
